...
public class WebantEmbedded {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(WebantEmbedded::console).start();
    }
...
*/
                    ...
                    else if (items.length >= 3) System.out.println(console.recrawl(items[1], items[2]));
                }
